...
export const NewsLetter = () => {
  return (
       <div className='max-w-7xl mx-auto flex flex-row justify-between items-center py-12 gap-8' >
        ...
        <div className="w-1/2 bg-linear-to-r from-orange-400 to-orange-600 p-12 rounded-2xl">
            <img
